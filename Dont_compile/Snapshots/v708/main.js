...
function loadedE() {
	...
	$('#admin2 #computer_check .hide_btn').mouseenter(showObject);
	$('#admin2 #computer_check .hide_btn').mouseleave(hideObject);
	...
	addButton($('#admin2 #computer_check .hide_btn'), function(e){
