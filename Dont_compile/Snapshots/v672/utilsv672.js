...
function inBounds(obj, leeway, logging) {
	...
	if (logging) {
		addLine("X = " + mouseX + ", L = " + obj.offset().left);
		addLine("W = " + obj[0].getBoundingClientRect().width);
		addLine("Y = " + mouseY + ", T = " + obj.offset().top);
		addLine("H = " + obj[0].getBoundingClientRect().height);
	}
	return false;
}
