...
/*var avatar_images_arr = [
	...
	// 500
	11153, // Evilâ˜…Twin Ki-sikil
	11154, // Evilâ˜…Twin Lil-la
...
var tokens = [{ "id": ["1", "1-2", "1-3", "1-4"], "name": "Sheep Token", "cards": ["Scapegoat"] }, { "id": "2", "name": "Slime Token", "cards": ["Jam Breeding Machine", "Reactor Slime"] }, { "id": "3", "name": "Poisonous Snake Token", "cards": ["Cobra Jar"] }, { "id": "4", "name": "Wicked Token", "cards": ["Statue of the Wicked"] }, { "id": "5", "name": "Mirage Token", "cards": ["Physical Double"] }, { "id": "6", "name": "Wicked Plant Token", "cards": ["Des Dendle"] }, { "id": ["7", "7-2", "7-3", "7-4", "7-5"], "name": "Ojama Token", "cards": ["Ojama Trio", "Ojama Duo"] }, { "id": "8", "name": "Army Ant Token", "cards": ["Multiplication of Ants"] }, { "id": ["9", "9-2"], "name": "Lamb Token", "cards": ["Stray Lambs"] }, { "id": "10", "name": "Lekunga Token", "cards": ["Lekunga"] }, { "id": "11", "name": "Insect Monster Token", "cards": ["Insect Queen", "Metamorphosed Insect Queen"] }, { "id": "12", "name": "Phantasm Token", "cards": ["Raviel, Lord of Phantasms"] }, { "id": "13", "name": "Phantasmal Martyr Token", "cards": ["Phantasmal Martyrs"] }, { "id": "14", "name": "Option Token", "cards": ["Victory Viper XX03"] }, { "id": "15", "name": "Double Dude Token", "cards": ["Destiny HERO - Double Dude"] }, { "id": "16", "name": "Synthetic Seraphim Token", "cards": ["Synthetic Seraphim"] }, { "id": "17", "name": "Block Token", "cards": ["Blockman"] }, { "id": "18", "name": "Wild Fire Token", "cards": ["Wild Fire"] }, { "id": "19", "name": "Cloudian Token", "cards": ["Cloudian - Sheep Cloud"] }, { "id": "20", "name": "Metal Fiend Token", "cards": ["Fiend's Sanctuary"] }, { "id": "21", "name": "Clone Token", "cards": ["Cloning"] }, { "id": "22", "name": "Grinder Token", "cards": ["Grinder Golem"] }, { "id": "23", "name": "Skyblaster Token", "cards": ["Phantom Skyblaster"] }, { "id": ["24", "24-2"], "name": "Doomsday Token", "cards": ["Fires of Doomsday"] }, { "id": "25", "name": "Evil Token", "cards": ["Vicious Claw"] }, { "id": "26", "name": "Metabo Token", "cards": ["Metabo Globster"] }, { "id": "27", "name": "Regenerating Rose Token", "cards": ["Regenerating Rose"] }, { "id": "28", "name": "Sinister Seed Token", "cards": ["Sinister Seeds"] }, { "id": "29", "name": "Thunder Option Token", "cards": ["Blue Thunder T-45"] }, { "id": "30", "name": "Moon Token", "cards": ["Arcana Force XVIII - The Moon"] }, { "id": "31", "name": "Engine Token", "cards": ["Fiendish Engine \u03a9", "Motor Shell", "Motor Frenzy"] }, { "id": "32", "name": "Oyster Token", "cards": ["Oyster Meister"] }, { "id": "33", "name": "Tricky Token", "cards": ["Tricky Spell 4"] }, { "id": "34", "name": "Rose Token", "cards": ["Black Garden", "Blooming of the Darkest Rose", "Garden Rose Flora"] }, { "id": "35", "name": "Seed Token", "cards": ["Seed of Flame"] }, { "id": "36", "name": "Fireball Token", "cards": ["Goka, the Pyre of Malice", "Graveyard of Wandering Souls"] }, { "id": "37", "name": "Gift Fiend Token", "cards": ["Revival Gift"] }, { "id": "38", "name": "Horseytail Token", "cards": ["Horseytail"] }, { "id": "39", "name": "Ivy Token", "cards": ["Wall of Ivy"] }, { "id": "40", "name": "Needle Token", "cards": ["Cactus Fighter"] }, { "id": "41", "name": "Plant Token", "cards": ["Bamboo Scrap"] }, { "id": "42", "name": "Emissary of Darkness Token", "cards": ["Gorz the Emissary of Darkness"] }, { "id": ["43", "43-2"], "name": "Fluff Token", "cards": ["Dandylion"] }, { "id": "44", "name": "Eva Token", "cards": ["Zeta Reticulant"] }, { "id": "45", "name": "Nightmare Archfiend Token", "cards": ["Nightmare Archfiends"] }, { "id": "46", "name": "Kuriboh Token", "cards": ["Detonate", "Multiply"] }, { "id": "47", "name": "Rockstone Token", "cards": ["Rockstone Warrior"] }, { "id": "48", "name": "Ghost Token", "cards": ["Damage Translation"] }, { "id": "49", "name": "Multi Token", "cards": ["Lord British Space Fighter"] }, { "id": "50", "name": "Reptilianne Token", "cards": ["Reptilianne Spawn", "Reptilianne Recoil"] }, { "id": "51", "name": "Soul Token", "cards": ["Limit Impulse"] }, { "id": "52", "name": "Spider Token", "cards": ["Spider Egg"] }, { "id": "53", "name": "Worm Token", "cards": ["Worm Bait"] }, { "id": "54", "name": "Ice Coffin Token", "cards": ["Royal Knight of the Ice Barrier"] }, { "id": "55", "name": "Ceremonial Token", "cards": ["Offering to the Immortals"] }, { "id": "56", "name": "Koa'ki Meiru Token", "cards": ["Koa'ki Meiru Prototype"] }, { "id": "57", "name": "Asmo Token", "cards": ["Darklord Asmodeus"] }, { "id": "58", "name": "Deus Token", "cards": ["Darklord Asmodeus"] }, { "id": "59", "name": "Jurrac Token", "cards": ["Jurrac Stauriko"] }, { "id": "60", "name": "Spinos Token", "cards": ["Jurrac Spinos"] }, { "id": "61", "name": "Siphon Token", "cards": ["Star Siphon"] }, { "id": "62", "name": "Waltz Token", "cards": ["Battle Waltz"] }, { "id": "63", "name": "Compass Token", "cards": ["Cosmic Compass"] }, { "id": "64", "name": "Doppel Token", "cards": ["Doppelwarrior"] }, { "id": "65", "name": "Einherjar Token", "cards": ["Valkyrie of the Nordic Ascendant"] }, { "id": "66", "name": "Malus Token", "cards": ["The Golden Apples"] }, { "id": "67", "name": "Nordic Beast Token", "cards": ["Tanngrisnir of the Nordic Beasts"] }, { "id": "68", "name": "Laval Token", "cards": ["Searing Fire Wall"] }, { "id": "69", "name": "Maize Token", "cards": ["Sweet Corn"] }, { "id": "70", "name": "Photon Token", "cards": ["Photon Sanctuary"] }, { "id": "71", "name": "Chewbone Jr. Token", "cards": ["Chewbone"] }, { "id": ["72", "72-2", "72-3", "72-4"], "name": "Mecha Phantom Beast Token", "cards": ["Mecha Phantom Beast Raiten", "Mecha Phantom Beast Aerosguin", "Mecha Phantom Beast O-Lion", "Mecha Phantom Beast Jaculuslan", "Mecha Phantom Beast Turtletracer", "Mecha Phantom Beast Megaraptor", "Mecha Phantom Beast Tetherwolf", "Mecha Phantom Beast Blackfalcon", "Mecha Phantom Beast Stealthray", "Mecha Phantom Beast Hamstrat", "Mecha Phantom Beast Dracossack", "Scramble!! Scramble!!", "Aerial Recharge", "Do a Barrel Roll", "Mecha Phantom Beast Warbluran", "Mecha Phantom Beast Blue Impala", "Mecha Phantom Beast Coltwing", "Mecha Phantom Beast Harrliard", "Vertical Landing", "Mecha Phantom Beast Sabre Hawk", "Mecha Phantom Beast Kalgriffin", "Mecha Phantom Beast Auroradon"] }, { "id": "73", "name": "Umbral Horror Mirage Token", "cards": ["Corrupted Keys"] }, { "id": "74", "name": "Kagemusha Raccoon Token", "cards": ["Number 64: Ronin Raccoon Sandayu"] }, { "id": "75", "name": "Dark Soul Token", "cards": ["Dragonecro Nethersoul Dragon"] }, { "id": "76", "name": "Blackwing - Black Crest Token", "cards": ["Black Wing Revenge"] }, { "id": "77", "name": "Steam Token", "cards": ["Blackwing - Steam the Cloak"] }, { "id": "78", "name": "Battle Eagle Token", "cards": ["Number 42: Galaxy Tomahawk"] }, { "id": "79", "name": "Manipulator Token", "cards": ["Number C43: High Manipulator of Chaos"] }, { "id": "80", "name": "Phantom Token", "cards": ["Number 48: Shadow Lich"] }, { "id": ["81", "81-2", "81-3"], "name": "Hippo Token", "cards": ["Hippo Carnival", "Super Hippo Carnival"] }, { "id": "82", "name": "Infernoid Token", "cards": ["Void Expansion"] }, { "id": "83", "name": "Synchron Token", "cards": ["Synchron Carrier"] }, { "id": "84", "name": "DOG Fighter Token", "cards": ["Kozmo DOG Fighter"] }, { "id": "85", "name": "Radian Token", "cards": ["Radian, the Multidimensional Kaiju"] }, { "id": "86", "name": "Vassal Token", "cards": ["Mithra the Thunder Vassal"] }, { "id": "87", "name": "Utchatzimime Token", "cards": ["Phantasmal Lord Ultimitl Bishbaalkin"] }, { "id": ["88", "88-2", "88-3", "88-4"], "name": "Black Sheep Token", "cards": ["Scapeghost"] }, { "id": "89", "name": "Dragon Lord Token", "cards": ["Ruins of the Divine Dragon Lords"] }, { "id": "90", "name": "Vague Shadow Token", "cards": ["Blackwing - Gofu the Vague Shadow"] }, { "id": "91", "name": "Crystron Token", "cards": ["Crystron Rosenix"] }, { "id": "92", "name": "Mini Mare Mare Token", "cards": ["Mare Mare"] }, { "id": "93", "name": "Shinobird Token", "cards": ["Shinobaroness Peacock", "Shinobaron Peacock", "The Himorogi where Stars Align"] }, { "id": "94", "name": "Ancient Gear Token", "cards": ["Ancient Gear Catapult"] }, { "id": "95", "name": "Jurraegg Token", "cards": ["Lost World"] }, { "id": "96", "name": "Phantasm Spiral Token", "cards": ["Pacifis, the Phantasm City"] }, { "id": "97", "name": "Vendread Token", "cards": ["Vendread Reorigin"] }, { "id": "98", "name": "Dragonoid Token", "cards": ["Dragonoid Generator"] }, { "id": "99", "name": "Security Token", "cards": ["One-Time Passcode"] }, { "id": "100", "name": "Stag Token", "cards": ["Boot Staggered"] }, { "id": "101", "name": "Tindangle Token", "cards": ["Tindangle Acute Cerberus"] }, { "id": "102", "name": "Torment Token", "cards": ["Lair of Darkness"] }, { "id": "103", "name": "Batteryman Token", "cards": ["Batteryman Solar"] }, { "id": "104", "name": "Data Token", "cards": ["Link Streamer"] }, { "id": "105", "name": "World Legacy Token", "cards": ["World Legacy - \"World Lance\"", "Girsu, the Orcust Mekk-Knight"] }, { "id": "106", "name": "Sky Striker Ace Token", "cards": ["Sky Striker Mecha - Hornet Drones"] }, { "id": "107", "name": "Congester Token", "cards": ["Cluster Congester"] }, { "id": "108", "name": "Cynet Token", "cards": ["Cynet Ritual"] }, { "id": "109", "name": "Link Token", "cards": ["Link Devotee", "Linkross"] }, { "id": "110", "name": "Data Acorn Token", "cards": ["Datacorn"] }, { "id": "111", "name": "Gadget Token", "cards": ["Cyberse Gadget"] }, { "id": "112", "name": "Clock Token", "cards": ["Clock Wyvern"] }, { "id": "113", "name": "Noble Knight Token", "cards": ["Noble Knight Iyvanne"] }, { "id": "114", "name": "Divine Dragon Token", "cards": ["White Aura Bihamut"] }, { "id": "115", "name": "Prank-Kids Token", "cards": ["Prank-Kids Pranks"] }, { "id": "116", "name": "Lunalight Token", "cards": ["Lunalight Serenade Dance"] }, { "id": "117", "name": "Shiranui Token", "cards": ["Shiranui Swordsaga"] }, { "id": "118", "name": "Squid Ink Token", "cards": ["Squirt Squid"] }, { "id": "119", "name": "T.G. Token", "cards": ["T.G. Tank Grub"] }, { "id": "120", "name": "Trickstar Token", "cards": ["Trickstar Live Stage", "Trickstar Festival"] }, { "id": "121", "name": "Fox Token", "cards": ["Nine-Tailed Fox"] }, { "id": "122", "name": "Overflow Token", "cards": ["Overflow Dragon"] }, { "id": "123", "name": "Spool Token", "cards": ["Spool Code"] }, { "id": "124", "name": "Duel Dragon Token", "cards": ["Duel Link Dragon, the Duel Dragon"] }, { "id": "125", "name": "Primal Being Token", "cards": ["Nibiru, the Primal Being"] }, { "id": "126", "name": "Generaider Token", "cards": ["Generaider Boss Stage"] }, { "id": "127", "name": "Bellcat Token", "cards": ["Bellcat Fighter"] }, { "id": "128", "name": "Moult Token", "cards": ["Transcicada"] }, { "id": "129", "name": "Tenyi Spirit Token", "cards": ["Tenyi Spirit - Sahasrara"] }, { "id": "130", "name": "@Ignister Token", "cards": ["The Arrival Cyberse @Ignister", "You and A.I."] }, { "id": "131", "name": "Familiar of the Evil Eye Token", "cards": ["Evil Eye Reemergence"] }, { "id": "132", "name": "Speedroid Token", "cards": ["Speedroid Block-n-Roll"] }, { "id": "133", "name": "Dual Avatar Spirit Token", "cards": ["Dual Avatar Invitation", "Perfect Sync - A-Un", "Dual Avatar Return"] }, { "id": "134", "name": "Ancient Warriors Token", "cards": ["Ancient Warriors Saga - Chivalrous Path"] }, { "id": "135", "name": "Ice Barrier Token", "cards": ["Speaker for the Ice Barriers"] }, { "id": "136", "name": "Ogdoadic Token", "cards": ["Ogdoadic Calling", "Ogdoadic Dawn of Creation"] }, { "id": "137", "name": "Otoshidamashi Token", "cards": ["Otoshidamashi"] }, { "id": "138", "name": "Tellus Wing Token", "cards": ["Tellus the Little Angel"] }, { "id": "139", "name": "Beetrooper Token", "cards": ["Beetrooper Formation", "Beetrooper Descent", "Beetrooper Squad"] }, { "id": "140", "name": "Stardust Token", "cards": ["Stardust Trail"] }, { "id": "141", "name": "Swordsoul Token", "cards": ["Swordsoul of Mo Ye", "Swordsoul of Taia", "Swordsoul Strategist Longyuan", "Swordsoul Assessment", "Swordsoul Blackout", "Swordsoul Strife"] }, { "id": "142", "name": "Mask Token", "cards": ["Ecole de Zone"] }, { "id": "143", "name": "Adventurer Token", "cards": ["Rite of Aramesir", "Water Enchantress of the Temple", "Magicore Warrior of the Relics", "Wandering Gryphon Rider", "Fateful Adventure", "Dunnell, the Noble Arms of Light", "Starlit Papillon", "Dracoback, the Rideable Dragon", "Zaralaam the Dark Palace", "Forest of Lost Flowers", "Thunder Discharge", "Breath of Resurrection", "Celestial Apparatus Tesea", "Curse of Aramatir", "Illegal Knight"] }, { "id": "144", "name": "Dinomorphia Token", "cards": ["Dinomorphia Shell"] }, { "id": "145", "name": "Epigonos Token", "cards": ["Epigonen, the Impersonation Invader"] }, { "id": "146", "name": "Iceblade Token", "cards": ["Branded Sword"] }, { "id": "147", "name": "Alligator Token", "cards": ["Dark Alligator"] }, { "id": "148", "name": "Fire Token", "cards": ["Libromancer Realized"] }, { "id": "149", "name": "Haunted Token", "cards": ["Haunted Zombies"] }, { "id": "150", "name": "Parasomnia Token", "cards": ["Parasomnia Pillow"] }, { "id": "151", "name": "V-LAN Token", "cards": ["V-LAN Hydra"] }, { "id": "152", "name": "Crystal Beast Token", "cards": ["Crystal Aegis"] }, { "id": "153", "name": "Phantom Glimmer Token", "cards": ["Blackwing - Sudri the Phantom Glimmer"] }, { "id": "154", "name": "Vilepawn Salmon Token", "cards": ["Infernalqueen Salmon"] }, { "id": "155", "name": "G Golem Token", "cards": ["G Golem Rock Hammer"] }, { "id": "156", "name": "Gadget Box Token", "cards": ["Gadget Box"] }, { "id": "157", "name": "Dark Beast Token", "cards": ["Chaos Witch"] }, { "id": "158", "name": "Light Beast Token", "cards": ["Chaos Witch"] }, { "id": "159", "name": "Nytro Token", "cards": ["Gold Pride - Nytro Head"] }, { "id": "160", "name": "Dragon Token", "cards": ["Wish Dragon"] }, { "id": "161", "name": "Hundred Apples Token", "cards": ["Ringowurm, the Dragon Guarding the Hundred Apples"] }, { "id": "162", "name": "Icejade Token", "cards": ["Icejade Ran Aegirine"] }, { "id": "163", "name": "Nouvelles Token", "cards": ["Recette de Personnel (Staff Recipe)"] }, { "id": "164", "name": "Baby Mantis Token", "cards": ["Praying Mantis"] }, { "id": "165", "name": "Runick Token", "cards": ["Sleipnir the Runick Mane"] }];
var tokens_arr = [];
var token_ids = [];
...
function joinDuelResponse(data) {
	...
	if (data.rating.indexOf(" (Expert)") >= 0) {
		...
		cell.find('span').html(cell.find('span').html().replace(' (Expert)', ' <font color="#009900">(Expert)</font>'));
	}
	if (data.rating.indexOf(" (Deck contains under 40 cards)") >= 0) {
		...
		cell.find('span').html(cell.find('span').html().replace(' (Deck contains under 40 cards)', ' <font color="#FF0000">(Deck contains under 40 cards)</font>'));
	}
...
function newDeckE() {
	...
	getInput("New Deck", "Enter a name for your new deck:", "", 25, newDeck, /[^ -~â—]/g);
	showDim();
}
...
function renameDeckE() {
	...
	getInput("Rename deck", "Enter a new name for your deck:", deck.data, 25, renameDeck, /[^ -~â—]/g);
	showDim();
}
...
function importDeckE() {
	...
	getInput("Import Deck", "Enter a name for your new deck", importedDeckName, 20, importDeckF, /[^ -~â—]/g);
	showDim();
}
...
function importYDK(str) {
	...
	for (var i = mainStart; i < extraStart; i++) {
		if (ydkData.charAt(i) == newlineChar) {
...
function createTokens() {
	if (tokens_arr.length == 0) {
		tokens.forEach(function (e, i) {
			//console.log(e);
			var ids = asArray(e.id);
			//console.log(ids);
			ids.forEach(function (id, j) {
				createNewToken(id, e.name, e.cards);
				token_ids.push(id);
			});
		});
		//token_ids.forEach(function(e,i){
		//	createNewToken(e);
		//});
		//for (var i = 0; i < 104; i++) {
		//	createNewToken(i + 1);
	...
	tokens_arr.splice(token_ids.length);
	outerloop:
	for (var i = 0; i < custom_tokens_arr.length; i++) {
		//for (var j = 104; j < tokens_arr.length; j++) {
		for (var j = token_ids.length; j < tokens_arr.length; j++) {
...
function createNewToken(id, name, cards) {
	var token = new Thumbnail();
	token.css("width", 45);
	token.css("height", 45);
	token.find('img').attr("src", (parseInt(id) > 20000 ? TOKEN_START : CARD_TOKENS_START) + (id) + '.jpg');
	token.click(selectToken);
	token.mouseenter(previewToken);
	token.data("id", id);
	token.data("name", Str(name).toLowerCase());
	token.data("cards", asArray(cards));
...
function tweenTokens(tweening) {
	...
	for (var i = 0; i < tokens_arr.length; i++) {
		if (tokens_arr[i][0].style.display == "none") {
			continue;
		}
		//console.log(tokenX);
...
function filterTokens() {
	tokens_arr.forEach(function (e, i) {
		e[0].style.display = "block";
	});
	var name = $('#token_select .filter_txt').val().toLowerCase();
	if (name) {
		outerloop:
		for (var i = 0; i < tokens_arr.length; i++) {
			var cards = asArray(tokens_arr[i].data("cards"));
			for (var j = 0; j < cards.length; j++) {
				if (cards[j].toLowerCase().indexOf(name) >= 0) {
					continue outerloop;
				}
			}
			if (tokens_arr[i].data("name") && tokens_arr[i].data("name").indexOf(name) >= 0) {
				continue;
			}
			tokens_arr[i].hide();
		}
...
function showToken() {
	...
	for (var i = 0; i < tokens_arr.length; i++) {
		if (selectedToken == tokens_arr[i].data("id")) {
			token_preview.data("id", tokens_arr[i].data("id"));
			break;
		}
	}
	//token_preview.find('img').attr("src", TOKEN_START + selectedToken + '.jpg');
	token_preview.find('img').attr("src", (parseInt(selectedToken) > 20000 ? TOKEN_START : CARD_TOKENS_START) + selectedToken + '.jpg');
...
function previewToken() {
	...
	preview.initializeFromData({
		...
		"pic": (parseInt($(this).data("id")) > 20000 ? TOKEN_START : CARD_TOKENS_START) + $(this).data("id") + '.jpg'
	});
	preview.clearLimit();
	preview.show();
}
...
function loadToken(data) {
	...
	token_preview.find('img').attr("src", (parseInt(data.id) > 20000 ? TOKEN_START : CARD_TOKENS_START) + data.pic);
...
function connectHandler() {
	Send({ "action": "Connect", "username": username, "password": password, "db_id": db_id, "session": session_id, "administrate": administrate, "version": VERSION, "capabilities": "", "remember_me": remember_me, "connect_time": connect_time, "fingerprint": 0, "html_client": true, "mobile": mobile, "browser": getBrowser(), "platform": getPlatform(), "degenerate": degenerate, "revamped": revamped, "zoom": ~~Zoom, "url": window.location.href, "fp1": FP1.toString(), "fp2": FP2.toString(), "fp3": FP3.toString(), "fp4": FP4.toString() });
	got_heartbeat = true;
...
function sendHeartbeat() {
	...
	if (searching) {
		...
		Send({ "action": "Searching", "search": saved_search ? saved_search.search : null });
	}
	else {
	...
	switch (data.action) {
		...
		case "Private message":
			...
			if (currentLabel == "messages") {
				if (clickedMessageUsername == data.username || clickedMessageUsername == data.receiver || awaiting_message) {
					addMessageLine(data);
					if (awaiting_message) {
		...
		case "Private chat error":
			...
			if (data.recaptcha) {
				//privateRecaptchaE();
				showRecaptcha(privateRecaptchaCallback);
			}
			if (awaiting_message) {
				awaiting_message = false;
				$('#messages .cin_txt').val(data.text);
		...
		case "Cancel reboot":
			rebooting = false;
			rebootTimer.reset();
			notificationClose($('.announcement:has(.title_txt:contains("Server Reboot"))'));
...
function showNotifications() {
	...
	for (var i = 0; i < notifications_arr.length; i++) {
		...
		if (notification.hasClass("notification")) {
			...
			notification_tweening = true;
			TweenMax.fromTo(notification, 0.7, { left: 1118 }, {
				left: 769, ease: Expo.easeInOut, delay: notification.data("fast") ? 0.25 : 1.5, onComplete: function () {
					for (var j = 0; j < notifications_arr.length; j++) {
						if (TweenMax.isTweening(notifications_arr[j])) {
							return;
						}
...
function notificationClose(notification) {
	...
	TweenMax.to(notification, 0.5, {
		alpha: 0, ease: Expo.easeInOut, onStart: function () {
			tweenNotificationsY();
		}, onComplete: function () {
			notification.remove();
		}
...
function gotoAdmin2(e, h, s) {
	...
	$('#ip_check .username_txt').focus();
	$('#ip_check .username_txt').select();
	if (s || (admin_status < 3 && moderator < 2)) {
		return;
	}
	$('#ip_check .super_cb').show();
...
function mainResizeE() {
	resizeE();
	if (mobile) {
		return;
	}
	//var zoom = getZoom();
	var zoom = getZoom(); // to help prevent NaN
	//if (Zoom != zoom) {
	if (Zoom != zoom) {
		...
		if (Math.round(zoom) != 100 && Math.round(zoom) != 125 && Math.round(zoom) != 0 && !isNaN(Math.round(zoom))) {
		...
		//else {
		else if (Math.round(zoom) == 100 || Math.round(zoom) == 125 && window.devicePixelRatio == 1.25) {
			var notification = new Notification();
...
function loadedE() {
	...
	initDB();
	try {
		//grecaptcha.render($('#recaptcha_bg .recaptcha')[0], {"sitekey":"6LdgBP8fAAAAAE7oh2Qc-MqjzJhS0qUwBSE0o8NJ", "callback":"registerRecaptchaCallback"}); // medium
		//grecaptcha.render($('#recaptcha_bg2 .recaptcha')[0], {"sitekey":"6LcwzlIlAAAAAHlxDi-6x9fzGhyfUXnAaYOyW0KD", "callback":"privateRecaptchaCallback"}); // hard
		grecaptcha.render($('#recaptcha_bg .recaptcha')[0], { "sitekey": "6LcwzlIlAAAAAHlxDi-6x9fzGhyfUXnAaYOyW0KD", "callback": "recaptchaCallback" }); // hard
	}
	catch (err) {
	}
	window.onresize = mainResizeE;
	mainResizeE();
	...
	addDragging($('#actions'), ".background:first", ".actions_txt");
	...
	$('#public_chat .cout_txt').scroll(savePublicVSP);
	...
	$('#token_select .filter_txt').on('input', filterTokens);
	...
	//$('#duel .cin_txt').data("regex", /[^ -~\r\nâ—ÃœÃºÎ©Î²Î±â˜†â˜…Ã±Ã©Ã‰#âˆžÃ¤â‘ â‘¡â‘¢â‘£â‘¤â‘¥â‘¦â‘§â‘¨ãƒ»Ã—Ã¡â±¯]/g);
	...
	setTimeout(function () {
		...
		if (EDGE) {
			...
			TweenMax.to($('#start #card1'), 3, {
				z: 607, delay: 0.25, onStart: function () {
					for (var i = 0; i < 50; i++) {
			...
			TweenMax.to($('#start #card2'), 3, {
				z: 607, delay: 0.5, onComplete: function () {
					$('#start #card2').remove();
				}
			});
			TweenMax.to($('#start #card3'), 3, {
				z: 607, delay: 0.75, onComplete: function () {
					$('#start #card3').remove();
				}
			});
			TweenMax.to($('#start #card4'), 3, {
				z: 607, delay: 1, onComplete: function () {
					tweenMonsters();
				}
			});
			TweenMax.to($('#start #card5'), 3, {
				z: 607, delay: 1.25, onComplete: function () {
					$('#start #card5').remove();
				}
			});
		}
	...
	function tweenMonsters() {
		...
		TweenMax.fromTo($('#brionac'), 0.5, { z: 226 }, {
			z: 910, ease: Linear.easeNone, delay: 2, onComplete: function () {
				$('#brionac').detach();
			}
		});
		TweenMax.fromTo($('#scout'), 0.5, { z: 226 }, {
			z: 910, ease: Linear.easeNone, delay: 2.2, onComplete: function () {
				$('#scout').hide();
			}
		});
		TweenMax.fromTo($('#hanzo'), 0.5, { z: 226 }, {
			z: 910, ease: Linear.easeNone, delay: 2.4, onComplete: function () {
				$('#hanzo').hide();
			}
		});
		TweenMax.fromTo($('#hornet'), 0.5, { z: 226 }, {
			z: 910, ease: Linear.easeNone, delay: 2.6, onComplete: function () {
				$('#hornet').hide();
			}
		});
		TweenMax.fromTo($('#neptabyss'), 0.5, { z: 226 }, {
			z: 910, ease: Linear.easeNone, delay: 2.8, onComplete: function () {
				$('#neptabyss').hide();
			}
		});
		TweenMax.fromTo($('#gorilla'), 0.5, { z: 226 }, {
			z: 910, ease: Linear.easeNone, delay: 3, onComplete: function () {
				$('#gorilla').hide();
				clearInterval(twinkle_interval);
				if (currentLabel != "start") {
					return;
				}
				TweenMax.fromTo($('#front_page'), 1, { alpha: 0, z: -200 }, {
					alpha: 1, z: 0, transformPerspective: 600, ease: Circ.easeInOut, onComplete: function () {
...
function Twinkle() {
	var twinkle = $('<img class="twinkle" src="' + IMAGES_START + 'twinkle.webp" />');
...
function twinkleE(ease) {
	...
	TweenMax.fromTo(twinkle, 1.3, { z: -400 }, {
		z: 600, "ease": ease, onComplete: function () {
			twinkle.remove();
		}
	});
}
...
function cardE() {
	...
	TweenMax.fromTo(card, 1, { z: -400 }, {
		z: 600, ease: Linear.easeNone, onComplete: function () {
			card.remove();
		}
	});
}
...
function Thumbnail() {
	...
	var img = $('<img src="' + IMAGES_START + 'blank.webp" />');
...
function Sleeve() {
	...
	var img = $('<img class="image" src="' + IMAGES_START + 'blank.webp" />');
...
function editStatusResponse(data) {
	for (var i = 0; i < status_arr.length; i++) {
		if (status_arr[i].data("id") == data.id) {
			...
			status_arr[i].find('.status_txt').html('<span class="not_link">' + escapeHTMLWithLinks(data.status, true) + '</span><font style="font-size: 11px;" color="#BBBBBB"> (edited)</font>');
			restoreStatuses();
			return;
		}
	}
	...
	for (var i = 0; i < status_arr.length; i++) {
		if (status_arr[i].data("id") == data.id) {
			...
			if (post_reply.data("id") == data.id) {
				TweenMax.to(post_reply, 0.5, {
					alpha: 0, ease: Expo.easeInOut, onComplete: function () {
						post_reply.hide();
					}
				});
			}
...
function ableToPost(str) {
	...
	if (str.split(String.fromCharCode(13)).length - 1 > 8 && !moderator) {
		errorE("There are too many line breaks in this status update");
		return false;
	}
	if (str.split(String.fromCharCode(10)).length - 1 > 8 && !moderator) {
		errorE("There are too many line breaks in this status update");
		return false;
	}
	if (muted) {
...
function editStatus(e) {
	...
	var str = status.find('.status_txt').text();
	if (!ableToPost(str)) {
		return;
	}
	Send({ "action": "Edit status", "id": status.data("id"), "status": str });
	//status.data("timer").callback();
	status.find('.save_btn').hide();
	status.find('.status_txt').on('input', onStatusInput);
}

function onStatusInput() {
	$(this).parents('.status').find('.save_btn').show();
	$(this).off('input', onStatusInput);
}
...
function deleteStatusE(e) {
	...
	if (moderator) {
		...
		if (moderator > 1) {
			options += '<option value="Edit status">Edit Status</option>';
		}
...
function editStatusE(status) {
	/*status.find('.status_txt').attr("contenteditable", true);

contenteditable

	status.find('textarea').show();
	status.find('textarea').text(status.find('.status_txt').text());
	status.find('.status_txt').hide();
	status.find('.save_btn').show();*/
}
...
function postStatusResponse(data) {
	...
	if (data.u == username || moderator >= 2) {
		...
		save_btn.hide();
		reply.append(save_btn);
		reply.find('.status_txt').mousedown(function (e) {
			if (e.target.closest('.link')) {
				e.stopPropagation();
				return;
			}
			reply.find('.status_txt').find('font[color="#BBBBBB"]:contains("(edited)")').detach();
			reply.find('.status_txt').attr("contenteditable", true);
			$('html').on('mousedown', stopEditable);

			function stopEditable(e) {
				if ($(e.target).parents('.status_txt').length > 0) {
					return;
				}
				reply.find('.status_txt').attr("contenteditable", false);
				$('html').off('mousedown', stopEditable);
			}
		});
		reply.find('.status_txt').on('input', onStatusInput);
	}
	...
	TweenMax.from(reply, 0.8, {
		left: parseInt(reply.css("left")) + 600, alpha: 0, ease: Expo.easeInOut, onComplete: function () {
	...
	//statusY = status.data("statusY") + status[0].scrollHeight + 10;
	TweenMax.to(post_status, time, {
		top: statusY, ease: Expo.easeInOut, onComplete: function () {
			//scrollPane2.update();
		}
	});
	...
	if (max) {
		...
		var maxVSP = $('#statuses').scrollMax();
		TweenMax.fromTo($('#statuses'), time, { scrollTop: maxVSP + 1000 }, {
			scrollTop: maxVSP + 1000, ease: Expo.easeInOut, onComplete: function () {
...
function postStatusE() {
	...
	var maxVSP = $('#statuses').scrollMax();
	tweenScrollbar($('#statuses'), 0.8, {
		scrollTop: maxVSP, ease: Expo.easeInOut, onComplete: function () {
	...
	if (~~post_reply.data("id") == id) {
		...
		for (var i = 0; i < status_arr.length; i++) {
			if (status_arr[i].data("id") == id) {
				...
				if (tween) {
					tweenScrollbar($('#statuses'), 0.5, {
						scrollTop: parseInt(post_reply.css("top")) - (revamped ? 681 : 545) + 228, ease: Expo.easeInOut, onComplete: function () {
							$('#post_reply .status_txt').focus();
						}
					});
					return;
...
function restoreStatuses() {
	...
	TweenMax.to(post_status, 0.5, {
		top: postY, ease: Expo.easeInOut, onComplete: function () {
			$('#statuses').trigger("scroll");
		}
	});
}
...
function loadOfflineMessages(data) {
	console.log('loadOfflineMessages');
	...
	for (var i = 0; i < data.privateChatUsernames.length; i++) {
		console.log(data.privateChatUsernames[i]);
		openPrivate(data.privateChatUsernames[i], data.privateChatLimits[i]);
	}
	$('#private_chat .users .cell').data("new_msg", true);
	$('#private_chat .users .cell').addClass("glowing");
	determineAnimate();
	playSound(ChatInbound);
		...
		if (admin >= 3 || moderator >= 2) {
			...
			for (var j = 0; j < pieces.length; j++) {
				if (pieces[j].indexOf('<a') != 0) {
					...
					note += '<a class="eventtext" href="javascript:' + callback + '(' + arr[i].id + ', ' + arr[i].hidden + ", '" + reason + "'" + ');">'; // escaping any of these characters causes issues in obfuscator
...
function loadPublicChatE() {
	...
	publicChatLimit += 50;
	loadPublicChat();
	public_chat.find('.cin_txt').focus();
}
...
function markRead(str) {
	if (!activated) {
		unread_message = str;
		return;
	}
	Send({ "action": "Read message", "username": str });
}
...
function determineAnimate() {
	var usernames = [];
	private_chat.find('.cell').filter(function () {
		return $(this).data("new_msg");
	}).each(function () {
...
function startPrivateAnimation() {
	...
	TweenMax.fromTo($('#private_btn'), 0.5, { width: 40, height: 36 }, {
		width: 54, height: 49, ease: Linear.easeNone, onComplete: function () {
			TweenMax.fromTo($('#private_btn_anim'), 0.5, { width: 54, height: 49, opacity: 1 }, { width: 40, height: 36, opacity: 0, ease: Linear.easeNone });
			TweenMax.fromTo($('#private_btn'), 0.5, { width: 54, height: 49 }, {
				width: 40, height: 36, ease: Linear.easeNone, onComplete: function () {
					startPrivateAnimation();
				}
			});
		}
...
function privateChatPrint(data) {
	...
	if (private_chat.find('.cell.selected').text() == otherPerson) {
		...
		savePrivateVSP();
		private_chat.find('.read_message').detach();
		private_chat.find('.cout_txt').append(content);
		cell.data("cout", private_chat.find('.cout_txt').html());
		restorePrivateVSP();
		if (!fromMe && private_chat.is(":visible")) {
...
function readMessage(data) {
	var content = '<font class="read_message">Read<br></font>';
	if (private_chat.find('.cell.selected').data("username") == data.username) {
		savePrivateVSP();
		private_chat.find('.cout_txt .read_message').detach();
		private_chat.find('.cout_txt').append(content);
		private_chat.find('.cell.selected').data("cout", private_chat.find('.cout_txt').html());
		restorePrivateVSP();
	}
	else {
		var cell = private_chat.find('.cell').filter(function () {
			return $(this).data("username") == data.username;
		});
		if (cell.length > 0 && cell.data("cout").indexOf(".read_message") < 0) {
			cell.data("cout", cell.data("cout") + content);
		}
	}
	if (clickedMessageUsername == data.username) {
		saveMessagesVSP();
		$('#messages .cout_txt .read_message').detach();
		$('#messages .cout_txt').append(content);
		restoreMessagesVSP();
	}
}
...
function stopChatCycle(p) {
	TweenMax.fromTo(p, 0.25, { opacity: 1 }, {
...
function poolsPrevE(fast) {
	...
	tweenScrollbar($('#formats'), speed, {
		"scrollLeft": left, ease: Circ.easeInOut, onComplete: function () {
...
function loadNews() {
	...
	xhr.onreadystatechange = function () {
		if (xhr.readyState == 4 && xhr.status == 200) {
			...
			if (degenerate) {
				$('#bulletin_txt span:first').prepend('<font color="#FF0000" style="font-size: 14px;">Notice: You are currently using the site in degenerate mode, meaning you will see status updates that are deemed too degenerate for all users to see. To view the site in normal mode, use this link: ' + escapeHTMLWithLinks('https://www.duelingbook.com/') + '</font><br><br>');
			}
...
function checkLoggedInResponse(resp) {
	...
	switch (data.action) {
		case "Not logged in":
			administrate = false;
			if (currentLabel == "front_page" && $('#login').is(":visible")) {
				switchAccountE();
			}
			break;
		case "Logged in":
...
function showLogin(e) {
	...
	if (!banned && checked_logged_in && !logged_in && e !== false && logins.length > 0) {
		//if (!banned && !logged_in && e !== false && logins.length > 0) { // removing checked_logged_in because i'm sick of having no login option after skipping the intro before checked_logged_in returns true // instead i changed checkLoggedInResponse
		switchAccountE();
	}
}
...
function performRegisterResponse(str) {
	...
	switch (data.action) {
		case "Registered":
			...
			return;
		case "Recaptcha":
			//showRegisterRecaptcha();
			showRecaptcha(registerRecaptchaCallback);
			return;
		case "Error":
			errorE(data.message);
			return;
...
function showRecaptcha(callback) {
	$(':focus').blur();
	$('#recaptcha_bg').show();
	$('#recaptcha_bg').data("callback", callback);
...
function recaptchaCallback(token) {
	...
	$('#recaptcha_bg').data("callback")(token);
}

function registerRecaptchaCallback(token) {
	console.log('registerRecaptchaCallback');
	performRegister(token);
	hideRecaptcha();
}

function privateRecaptchaCallback(token) {
	console.log('privateRecaptchaCallback');
...
function privateRecaptchaE() {
	hideDisplayBoxes();
	showRecaptcha(privateRecaptchaCallback)
}

function showRegisterRecaptcha(callback) {
	//$(':focus').blur();
	$('#recaptcha_bg').show();
	grecaptcha.reset();
	//$('.grecaptcha-badge:last').css("visibility", "hidden");
...
function togglePrivate(e) {
	...
	if ($('#private_chat').is(':visible')) {
		...
		console.log(private_chat.find('.cell').length == 1);
		console.log(private_chat.find('.cell.selected').length);
		console.log(private_chat.find('.cell.selected.glowing').length == 1);

		//if (private_chat.find('.cell').length == 1 && private_chat.find('.cell.glowing').length == 1 || private_chat.find('.cell.selected.glowing').length == 1) {
		//if (private_chat.find('.cell').length == 1 && private_chat.find('.cell.selected').length == 1 || private_chat.find('.cell.selected.glowing').length == 1) {
		//	markRead(private_chat.find('.cell.selected.glowing').data("username"));
		//}
		...
		if (private_chat.find('.cell.selected').data("new_msg") || private_chat.find('.cell.selected.glowing').length == 1) {
			markRead(private_chat.find('.cell.selected.glowing').data("username"));
		}
...
function updateRebootSeconds() {
	...
	$('.announcement:has(.title_txt:contains("Server Reboot")) .body_txt').text("The server will restart in " + rebootSeconds + " seconds");
}
...
function resetCustomCards() {
	...
	$('#upload_card .pendulum_sel').disable(true);
	$('#edit_card .pendulum_cb').checked(false);
	$('#edit_card .pendulum_sel').disable(true);
...
function clearCard() {
	...
	upload_card.find('.pendulum_sel').disable(true);
...
function initSearcher() {
	//$('#search .name_txt, #search .desc_txt').data("regex", /[^ -~â—\r\nÃœÃºÎ©Î²Î±â˜†â˜…Ã±Ã©Ã‰#âˆžÃ¤â‘ â‘¡â‘¢â‘£â‘¤â‘¥â‘¦â‘§â‘¨ãƒ»Ã—Ã¡â±¯]/g);
...
function initUploader() {
	...
	//$('.uploader .name_txt, .uploader .desc_txt, .uploader .pendulum_effect_txt').data("regex", /[^ -~â—\r\nÃœÃºÎ©Î²Î±â˜†â˜…Ã±Ã©Ã‰#âˆžÃ¤â‘ â‘¡â‘¢â‘£â‘¤â‘¥â‘¦â‘§â‘¨ãƒ»Ã—Ã¡â±¯]/g);
	...
	$('.uploader .pendulum_sel').disable(true);
	$('.uploader .pendulum_sel').selectedIndex(0);
	...
	$('.uploader .pendulum_sel').change(updateCard);
...
function updateCard() {
	...
	var is_effect = ~~((monster_color == "Normal" || monster_color == "Effect") || monster_color == "Ritual" && effect.indexOf(". ") >= 0 || ((monster_color == "Fusion" || monster_color == "Synchro" || monster_color == "Xyz" || monster_color == "Link") && (effect.indexOf(String.fromCharCode(10)) >= 0 || effect.indexOf(String.fromCharCode(13)) >= 0 || effect.indexOf(". ") >= 0))); // 10 = "\n" 13 = "\r"
	...
	var pendulum = obj.find('.pendulum_cb').prop("checked") ? obj.find('.pendulum_sel').val() : 0;
...
function cardChangeE() {
	...
	switch (obj.find('.card_cb').val()) {
		case "":
			...
			obj.find('.pendulum_sel').disable(true);
			obj.find('.pendulum_sel').selectedIndex(0);
		...
		case "Monster":
			...
			showArrows(obj);
			// passcode
			arr = ["", "Aqua", "Beast", "Beast-Warrior", "Celestial Warrior", "Cyberse", "Cyborg", "Dinosaur", "Divine-Beast", "Dragon", "Fairy", "Fiend", "Fish", "Galaxy", "High Dragon", "Illusion", "Insect", "Machine", "Magical Knight", "Omega Psychic", "Plant", "Psychic", "Pyro", "Reptile", "Rock", "Sea Serpent", "Spellcaster", "Thunder", "Warrior", "Winged Beast", "Wyrm", "Zombie"];
			break;
		case "Spell":
...
function togglePendulum() {
	...
	if (obj.find('.pendulum_cb').prop("checked")) {
		...
		obj.find('.pendulum_sel').disable(false);
...
function searchCardDrop(card, adding) {
	...
	if (adding) {
		...
		if (inBounds($('#extra_mask')) && isExtraDeckCard(card)) {
			addCardToExtra(draggedCard, getUnderlyingExtraCard());
		}
	}
	else {
...
function loadProfileResponse2(data) {
	...
	if (!simple) {
		...
		TweenMax.fromTo($('#profile_viewer2 .watch_duel_btn'), 0.375, { left: 1050 }, {
			left: 819, delay: 1.75, ease: Expo.easeOut, onComplete: function () {
...
function tweenSong() {
	...
	TweenMax.to($('#profile_song .name_txt'), time, {
		left: -width, ease: Linear.easeNone, onComplete: function () {
			TweenMax.fromTo($('#profile_song .name_txt'), 2, { left: 103 }, {
				left: 0, delay: 2, ease: Linear.easeNone, onComplete: function () {
					tweenSong();
				}
			});
		}
...
function postComment(e) {
	...
	str = stripSpaces(str);
	str = replaceReturns(str);
	if (str.split(String.fromCharCode(10)).length - 1 > 8) {
...
function replyToCommentE(e) {
	...
	tweenScrollbar($('#profile_content'), 0.7, {
		scrollTop: maxVSP, ease: Expo.easeInOut, onComplete: function () {
...
function replyToTestimonialE() {
	...
	tweenScrollbar($('.profile_content:visible'), 0.7, {
		scrollTop: maxVSP, ease: Expo.easeInOut, onComplete: function () {
...
function viewAllComments() {
	...
	TweenMax.fromTo($('#all_comments'), 1, { left: -1024 }, {
		left: 0, ease: Circ.easeInOut, onComplete: function () {
...
function viewAllFriends() {
	...
	TweenMax.fromTo($('#profile_content'), 1, { left: 0 }, { left: -1024, ease: Circ.easeInOut });
	TweenMax.fromTo($('#all_friends'), 1, { left: 1024 }, {
		left: 0, ease: Circ.easeInOut, onComplete: function () {
			$('#profile_content').hide();
			if (!friendsLoaded) {
				loadUserFriends();
...
function loadThumbnails(data) {
	...
	for (var i = 0; i < thumbs.length; i++) {
		...
		if (data.pics.length >= i + 1) {
			...
			thumb.find('img').attr("src", IMAGES_START + "blank.webp");
		...
		thumb.data("index", i);
		TweenMax.to(thumb, (i * 200 + 342) / 1000, {
			onComplete: function () {
				$(this.target).css("opacity", 1);
			}
		});
...
function gotoChangePassword() {
	...
	if (!simple) {
		...
		TweenMax.fromTo($('#change_password .change_password'), 0.7, { top: 660 }, {
			top: 377, ease: Expo.easeInOut, onComplete: function () {
...
function loadAllPrivateChatResponse(data) {
	...
	messages_obj = data;
	filterMessages();
	$('#messages .cout_txt').scrollTop($('#messages .cout_txt').scrollMax());
	$('#messages .cin_txt').focus();
	readInMessages(data);
	markRead(data.username);
}
...
function addMessageLine(data) {
	...
	$('#messages .cout_txt').find('.read_message').detach()
	...
	private_chat.find('.cell').filter(function () {
		return $(this).data("username") == data.username || $(this).data("username") == data.receiver;
	}).removeClass("glowing").data("new_msg", false);
}

('s' == ('r' || 's'))

function readInMessages(data) {
	$('#private_chat .cell').filter(function () {
		return $(this).data("username") == data.username;
	}).data("new_msg", false).removeClass("glowing");
	determineAnimate();
}
...
function storeClickE(e) {
	...
	TweenMax.fromTo(selectedStore, 0.8, { "top": parseInt(selectedStore.css("top")) - vsp }, {
...
function postReviewE() {
	...
	tweenScrollbar($('#tournament_locator .reviews_content'), 1, {
		scrollTop: maxVSP, ease: Expo.easeInOut, onComplete: function () {
			post_review.find('.review_txt').focus();
		}
	});
...
function initDuelist() {
	...
	//$('#field_stats > span').css("pointer-events", (rated || !duelist) && !admin && !adjudicator ? "none" : "auto");
	$('#field_stats > span').css("pointer-events", rated ? "none" : "auto");
...
function initCard(card, data, player) {
	...
	if (data.data) {
		...
		if (card.data("cardfront").data("monster_color") == "Token") {
			...
			card.data("cardfront").find('.image').attr("src", (parseInt(id) > 20000 ? TOKEN_START : CARD_TOKENS_START) + player.token_id + '.jpg');
		}
		if (!data.face_down) {
...
function duelChatLoaded(data) {
	...
	if (data.messages.length > 0) {
		...
		for (var i = 0; i < data.messages.length; i++) {
			...
			str += '<span class="duel_message"><font color="#' + color + '"><b>' + escapeHTML(data.messages[i].username) + ': </b></font><font>' + escapeHTMLWithLinks(data.messages[i].message) + '</font></span>';
		}
	}
...
function swapCardsE() {
	...
	for (var i = 0; i < deck_holes_arr.length; i++) {
		if (parseFloat(deck_holes_arr[i].css("opacity")) > 0) {
			...
			str += "Sided out " + deck_filled_arr[i].data("name") + newLineChar;
		}
	}
	for (i = 0; i < extra_holes_arr.length; i++) {
		if (parseFloat(extra_holes_arr[i].css("opacity")) > 0) {
			...
			str += "Sided out " + extra_filled_arr[i].data("name") + newLineChar;
		}
	}
	for (i = 0; i < side_holes_arr.length; i++) {
		if (parseFloat(side_holes_arr[i].css("opacity")) > 0) {
			...
			str += "Sided in " + side_filled_arr[i].data("name") + newLineChar;
		}
	}
...
function tweenLogos(b) {
	...
	TweenMax.fromTo($('#db_logo_top'), 0.83, { alpha: 0 }, {
		alpha: 0.75, ease: Linear.easeNone, onComplete: function () {
			TweenMax.fromTo($('#db_logo_top'), 0.83, { alpha: 0.75 }, {
				alpha: 0, delay: 1.667, onComplete: function () {
					tweenLogos();
				}
			});
		}
...
function tourneyClickE() {
	...
	TweenMax.fromTo(selectedTourney, 0.8, { "top": parseInt(selectedTourney.css("top")) - vsp }, {
		"top": 40, ease: Expo.easeInOut, onComplete: function () {
			tourney_ready = true;
			showTournament();
		}
	});
...
function showStatuses(e) {
	...
	TweenMax.fromTo($('#statuses0'), currentLabel == "main_menu" ? 1 : 0, { "left": width }, {
		"left": left, ease: Expo.easeInOut, onComplete: function () {
			$('#status_cb').show();
...
function jumpyText() {
	...
	$('.jumpy').each(function () {
		...
		function spinAround(f) {
			...
			TweenMax.to(f, 0.2, {
				"bezier": f.data("bezier"), "ease": Linear.easeNone, "onComplete": function () {
					spinAround(f);
				}
			});
		}
...
function editStatsE(e) {
	...
	if (!edit_stats_card0 || edit_stats_card0.data("controller") != player1 && !admin && !adjudicator) {
		return;
	}
